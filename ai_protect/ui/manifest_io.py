...
# Allow-listed enum values — match ai_protect/core/manifest.py + tiering.py.
# "all" is a meta-option: the app has multiple of these characteristics; tier
# conservatively at the most-restrictive value (handled in ai_protect/core/tiering.py).
...
def manifests_dir() -> Path:
    ...
    return Path(os.environ.get("AI_PROTECT_MANIFESTS_DIR",
                               "/home/user/ai-protect/ai_protect/manifests"))
