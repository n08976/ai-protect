...
Run:
    python -m ai_protect.ui.server --findings /tmp/findings.jsonl --port 8000
"""
...
def create_app(findings_path: str, manifests_dir: str) -> Flask:
    ...
    def scan_start():
        ...
        cmd = [
            "python3", "-m", "ai_protect.remediate.scan_runner",
...
# file keep working. Logic lives in ai_protect/core/dashboard.py and is shared
# with ai_protect/remediate/scan_runner.py — keeping the two paths from drifting.
...
def main():
    ...
    # ai_protect.ui.server` just works. A configured findings_path (Settings →
