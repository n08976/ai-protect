...
from ai_protect.integrations import (
    SinkContext,
    configured_sinks,
    get_sink,
    sink_names,
)
from ai_protect.integrations.defectdojo import (
    DefectDojoClient,
    DefectDojoConfig,
...
from ai_protect.integrations.defectdojo import config as dd_config
from ai_protect.integrations.defectdojo import sink as dd_sink
...
def test_cli_defectdojo_honors_manifest(tmp_path, monkeypatch):
    ...
    import ai_protect.integrations.defectdojo as ddpkg
    ...
    class _FakeSink:
        ...
        def push(self, findings, ctx):
            ...
            from ai_protect.integrations.base import SinkResult
